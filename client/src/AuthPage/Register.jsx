...
const Register = () => {
  ...
  return (
    <div className='flex justify-center flex-col ml-96 mt-2 m-10 p-4 w-1/3 h-auto register bg-gray-400 rounded-md'>
      <form onSubmit={handleRegister} className='flex flex-col m-2 w-full justify-center align-middle'>
        ...
        <input
          ...
          className='bg-zinc-600 px-2 py-2 m-3 rounded-lg'
        />
        <button className='px-2 py-2 bg-green-400 w-20 btn_register ml-64 rounded-md hover:bg-green-900 m-2' type="submit">Register</button>
